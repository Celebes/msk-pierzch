...
public class KoniecNiecierpliwosci extends BasicSimEvent<Zgloszenie, Object>
{
	...
	protected void onInterruption() throws SimControlException {
		//AA-test-AA System.out.println(simTime()+": Przerwanie niecierpliwoœci zgl. nr: " + parent.getTenNr());
	}
	...
	protected void stateChange() throws SimControlException {
		//AA-test-AA System.out.println(simTime()+": Koniec niecierpliwoœci zgl. nr: " + parent.getTenNr());
        if (parent.smo.usunWskazany(parent)){
        	//AA-test-AA System.out.println(simTime()+": Usuniêto z kolejki zgl. nr: " + parent.getTenNr());
            double lutrac = parent.smo.MVutraconeZgl.getValue();
            parent.smo.MVutraconeZgl.setValue(lutrac++);
        }
        else {
        	//AA-test-AA System.out.println(simTime()+": Problem z usuniêciem z kolejki zgl. nr: " + parent.getTenNr());
        }
	}
}