...
public class Zglaszaj extends BasicSimEvent<Otoczenie, Object>
{
	...
	protected void stateChange() throws SimControlException {
      ...
      //AA-test-AA System.out.println(simDate(SimDateField.HOUR24)+" - "+simDate(SimDateField.MINUTE)+" - "+simDate(SimDateField.SECOND)+" - "+simDate(SimDateField.MILLISECOND)+": Otoczenie: Dodano nowe zgl. nr: " + zgl.getTenNr());
